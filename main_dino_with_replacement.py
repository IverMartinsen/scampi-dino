...
def get_args_parser():
    ...
    parser.add_argument('--steps_per_epoch', default=750, type=int, help='Number of steps per epoch.')
    return parser
...
def train_dino(args):
    ...
    momentum_schedule = utils.cosine_scheduler(args.momentum_teacher, 1, args.epochs, args.steps_per_epoch)
    # --------------- modified code ---------------
...
def train_one_epoch(student, teacher, teacher_without_ddp, dino_loss, data_loader,
    ...
    # --------------- modified code ---------------
    dummy_iterable = range(args.steps_per_epoch)
    # --------------- modified code ---------------
